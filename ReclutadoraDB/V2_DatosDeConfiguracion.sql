...
-- SEGURIDAD
    ...
    VALUES
        ('ADMIN',       'Con este rol se puede hacer cualquier cosa'),
        ('EMPRESA',     'Con este rol se pueden hacer cosas de Empresa'),
        ('POSTULANTE',  'Con este rol se pueden hacer cosas de Postulante');
